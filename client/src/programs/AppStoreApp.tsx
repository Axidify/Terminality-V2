...
export const AppStoreApp: React.FC = () => {
  ...
  return (
  <div className="appstore-root" ref={containerRef} onContextMenu={handleContextMenu}>
      {/* Background effects */}
      ...
      {contextMenu && (
        <div
          className="appstore-context-menu"
          style={{ left: contextMenu.x, top: contextMenu.y }}
        >
          <div className="context-menu-item" onClick={() => { setSearchQuery(''); setSelectedCategory('all'); closeContextMenu() }}>
          ...
          <div className="context-menu-item" onClick={() => { alert(`App Store - Modular Apps Manager\n${pm.available.length} apps available`); closeContextMenu() }}>
            <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
